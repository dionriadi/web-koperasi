...
//get profil
$sql = "select `judul`, `isi` from `pengumuman` where `id_pengumuman`='$id_pengumuman'";
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h5 class="card-title" style="color: white; background-color: rgb(93, 93, 146); padding: 20px; border-radius: 10px;">Form Edit Pengumuman</h5>
                  ...
                  <div class="card-content">
                    <form class="form form-vertical" action="konfirmasi-edit-info" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                        <div class="form-group row">
                          <label for="nama" class="col-sm-3 col-form-label">Judul</label>
                            <div class="col-sm-7">
                              ...
                              <input type="hidden" class="form-control" name="id" id="id" value="<?php echo $id_pengumuman;?>">
                            </div>
                        </div>
                        <div class="form-group row">
